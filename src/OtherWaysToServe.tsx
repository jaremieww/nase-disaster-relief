  ...
  return <>
    <Box component="section">
      ...
      <ul>
        ...
        <li>Provide snacks for those at the command center, teams leaving to work in the field, and those camping.</li>
        <li>Help provide an evening meal for all workers when they return (likely Saturday). This could provide a service opportunity for many people who enjoy cooking for others and could be coordinated by a person or small committee.</li>
      ...
      <ul>
        ...
        <li>Donate to the Church's humanitarian fund</li>
        <li>Help fund those who can physically work with water, snacks, gas for travel, etc.</li>
        <li>Babysit so those with children can help. This is especially appreciated by younger mothers who often don't get to do the hands-on work outside of their own home.</li>
        <li>Check on neighbors and share crisis cleanup information</li>
        <li>Offer encouragement to those affected by disaster</li>
        <li>Help with laundry of those affected by disaster</li>
        <li>Share electricity with neighbors if you have it and they don't</li>
        <li>Write short notes of encouragement, love, and hope for teams to take to those they help</li>
        <li>Help fill in callings on Sunday for those that are working in the field</li>
