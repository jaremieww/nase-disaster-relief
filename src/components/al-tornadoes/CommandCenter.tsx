...
const CommandCenter = (props: CommandCenterProps) => {
  ...
  return <>
    ...
    <p>Please check <PopoutLink href="https://algotraffic.com/">https://algotraffic.com/</PopoutLink> for traffic updates and maps of the state of Alabama.</p>
...
function Training() {
  return <Space direction="vertical" style={{ marginTop: '40px' }}>
    ...
    <Alert type="info" message="Note" showIcon description={<>
      ...
      <PopoutLink href="https://www.churchofjesuschrist.org/callings/church-safety-and-health/chainsaw-safety?lang=eng">mandatory online chainsaw instruction</PopoutLink> or show a certificate.
