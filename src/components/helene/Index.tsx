    ...
    <div className="row">
      ...
      <section className="ccenter">
        <Space direction="vertical">
          ...
          <div className="stakesAssigned">Kingsland GA, Fort Walton Beach FL, Panama City FL, Tifton GA, Columbus GA, Macon GA, Jacksonville FL South</div>
          ...
          <div className="stakesAssigned">Cocoa FL, Palm Bay FL, St Cloud FL, Naples FL</div>
          <a href="helene/venice"><Space><AimOutlined />Venice</Space></a> 
          <div className="stakesAssigned">Coral Springs FL, Miami FL, Miami Lakes FL, Sarasota FL</div>
