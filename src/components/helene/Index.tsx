    ...
    <div className="row">
      ...
      <section className="ccenter">
        <Space direction="vertical">
          ...
          <div className="stakesAssigned">Sugar Hill GA, Lexington KY North, Lexington KY, Asheville NC, Cookeville TN, Knoxville TN</div>
          ...
          <div className="stakesAssigned">Cocoa FL, Leesburg FL, Orlando FL, Orlando FL West, Palm Bay FL, St Cloud FL</div>
